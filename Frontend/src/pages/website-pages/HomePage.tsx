      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <Button variant="outline" size="sm" className="rounded-lg border-[#1E3A28]/20 text-[#1C1C1C]" asChild>
              <Link to="/login">Log in</Link>
            </Button>
            <Button size="sm" className="rounded-lg px-5 bg-[#1E3A28] hover:bg-[#173420] text-white" asChild>
              <Link to="/demo">
                Request Demo
              </Link>
            </Button>
            ...
            >
              <nav className="flex flex-col py-4 gap-1">
                ...
                <div className="grid grid-cols-2 gap-3 p-4 mt-2">
                  <Button variant="outline" className="rounded-lg border-[#1E3A28]/20" asChild onClick={closeMenus}>
                    <Link to="/login">Log in</Link>
                  </Button>
                  <Button className="rounded-lg bg-[#1E3A28] hover:bg-[#173420] text-white" asChild onClick={closeMenus}>
