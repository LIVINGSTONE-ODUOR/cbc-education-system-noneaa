...
const regionData = [
  { name: 'Nairobi', value: 45, color: '#3b82f6' },
  { name: 'Mombasa', value: 20, color: '#10b981' },
  { name: 'Kisumu', value: 15, color: '#f59e0b' },
  { name: 'Nakuru', value: 12, color: '#8b5cf6' },
...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden text-white">
      ...
      {/* Animated orbs */}
      <motion.div className="absolute top-10 right-10 w-96 h-96 bg-blue-500/15 rounded-full blur-3xl" animate={{ scale: [1, 1.2, 1], opacity: [0.2, 0.4, 0.2] }} transition={{ duration: 8, repeat: Infinity }} />
      <motion.div className="absolute bottom-10 left-10 w-80 h-80 bg-cyan-500/15 rounded-full blur-3xl" animate={{ scale: [1.1, 1, 1.1], opacity: [0.3, 0.15, 0.3] }} transition={{ duration: 10, repeat: Infinity, delay: 1 }} />
      <motion.div className="absolute top-1/2 left-1/2 w-64 h-64 bg-purple-500/10 rounded-full blur-3xl" animate={{ scale: [1, 1.3, 1], opacity: [0.1, 0.3, 0.1] }} transition={{ duration: 12, repeat: Infinity, delay: 2 }} />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            ...
            <div className="flex flex-wrap gap-4 mb-10">
              <motion.a href="/features" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-lg inline-flex items-center gap-2 shadow-lg hover:shadow-blue-500/25">
                Explore Features <ArrowRight className="w-4 h-4" />
              </motion.a>
              <motion.a href="/contact" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="px-8 py-3 border-2 border-blue-400/50 text-blue-300 font-semibold rounded-lg hover:bg-blue-900/20 transition-all">
                Talk to Us
              </motion.a>
            </div>
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.3 }} className="hidden lg:block">
            <div className="relative">
              {/* Floating cards */}
              {[
                { icon: GraduationCap, label: 'CBC Aligned', color: 'from-blue-500 to-blue-600', x: 0, y: 0 },
                { icon: BarChart3, label: 'Real-time Analytics', color: 'from-emerald-500 to-emerald-600', x: 180, y: 60 },
                { icon: Brain, label: 'AI-Powered', color: 'from-purple-500 to-purple-600', x: 40, y: 140 },
                { icon: Shield, label: 'Data Secure', color: 'from-amber-500 to-amber-600', x: 220, y: 200 },
                { icon: Users, label: 'Teacher Tools', color: 'from-rose-500 to-rose-600', x: 100, y: 280 },
              ].map((card, i) => (
                <motion.div
                  key={i}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={scaleIn}>
              <div className="bg-white rounded-2xl border border-blue-200 p-8 h-full hover:shadow-lg transition-shadow">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={scaleIn} transition={{ delay: 0.15 }}>
              <div className="bg-white rounded-2xl border border-emerald-200 p-8 h-full hover:shadow-lg transition-shadow">
                <div className="flex items-center gap-4 mb-6">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={scaleIn}>
              <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                <h3 className="text-lg font-bold text-slate-900 mb-1">Platform Adoption</h3>
                <p className="text-sm text-slate-500 mb-4">Schools, students, and teachers over time</p>
                <ResponsiveContainer width="100%" height={300}>
                  <AreaChart data={growthData}>
                    ...
                    <Legend />
                    <Area type="monotone" dataKey="schools" stroke="#3b82f6" fill="url(#gSchools)" strokeWidth={2} name="Schools" />
                    <Area type="monotone" dataKey="students" stroke="#10b981" fill="url(#gStudents)" strokeWidth={2} name="Students" />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
            </motion.div>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={scaleIn} transition={{ delay: 0.15 }}>
              <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                <h3 className="text-lg font-bold text-slate-900 mb-1">Regional Presence</h3>
                <p className="text-sm text-slate-500 mb-4">Distribution of partner schools across Kenya</p>
                  ...
                  <div className="space-y-3">
                    {regionData.map((r, i) => (
                      <div key={i} className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-bold text-slate-900 ml-auto">{r.value}%</span>
                      </div>
                    ))}
                  </div>
                </div>
      ...
      <section className="py-20 bg-[#dfe5f0]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={scaleIn}>
              <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                <h3 className="text-lg font-bold text-slate-900 mb-1">Average Scores: Before vs After NONEAA</h3>
                <p className="text-sm text-slate-500 mb-4">Percentage improvement across subjects</p>
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={impactData} barGap={4}>
                    ...
                    <Bar dataKey="after" fill="#3b82f6" name="After NONEAA" radius={[4, 4, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </motion.div>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={scaleIn} transition={{ delay: 0.15 }}>
              <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                <h3 className="text-lg font-bold text-slate-900 mb-1">CBC Competency Development</h3>
                <p className="text-sm text-slate-500 mb-4">Average student scores across 7 core competencies</p>
                <ResponsiveContainer width="100%" height={300}>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              const colorMap: Record<string, { bg: string; iconBg: string; text: string }> = {
                blue: { bg: 'border-blue-200', iconBg: 'bg-blue-100', text: 'text-blue-600' },
                emerald: { bg: 'border-emerald-200', iconBg: 'bg-emerald-100', text: 'text-emerald-600' },
                purple: { bg: 'border-purple-200', iconBg: 'bg-purple-100', text: 'text-purple-600' },
                amber: { bg: 'border-amber-200', iconBg: 'bg-amber-100', text: 'text-amber-600' },
                rose: { bg: 'border-rose-200', iconBg: 'bg-rose-100', text: 'text-rose-600' },
                cyan: { bg: 'border-cyan-200', iconBg: 'bg-cyan-100', text: 'text-cyan-600' },
              };
      ...
      <section className="py-20 bg-[#dfe5f0]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative max-w-4xl mx-auto">
            {/* Timeline line */}
            <div className="absolute left-6 md:left-1/2 md:-translate-x-1/2 w-0.5 h-full bg-gradient-to-b from-blue-400 via-emerald-400 to-purple-400 opacity-30" />
            ...
            <div className="space-y-10">
              {[
                ...
                const isLeft = i % 2 === 0;
                const colorMap: Record<string, string> = { blue: 'bg-blue-600', emerald: 'bg-emerald-600', amber: 'bg-amber-600', purple: 'bg-purple-600' };
                return (
                  <motion.div
                    key={i}
      ...
      <section className="py-20 bg-[#e8edf5]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: Sparkles, title: 'Innovation First', desc: 'We challenge conventional edtech norms to build solutions that truly work in African classrooms.', gradient: 'from-blue-500 to-cyan-500' },
              { icon: Trophy, title: 'Excellence Always', desc: 'Every feature is tested with real teachers, iterated on real feedback, and held to the highest quality bar.', gradient: 'from-amber-500 to-orange-500' },
              { icon: Users, title: 'Community Driven', desc: 'We co-create with educators, parents, and education officials — our roadmap is shaped by the people we serve.', gradient: 'from-emerald-500 to-teal-500' },
              { icon: Globe, title: 'Impact at Scale', desc: 'Our success is measured not by revenue, but by the number of students whose lives are transformed.', gradient: 'from-purple-500 to-pink-500' },
            ].map((value, i) => (
            ...
            {[
              ...
              <motion.div key={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} transition={{ delay: i * 0.1 }}>
                <div className="bg-white rounded-2xl border border-gray-200 p-8 h-full hover:shadow-lg transition-shadow relative">
                  <div className="text-4xl text-blue-200 font-serif absolute top-4 left-6">"</div>
                  <p className="text-slate-600 leading-relaxed mb-6 pt-6 italic">{t.quote}</p>
              ...
              <motion.div key={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} transition={{ delay: i * 0.1 }}>
                <div className="bg-white rounded-xl border border-gray-200 p-6 text-center hover:shadow-md transition-shadow">
                  <div className="w-12 h-12 rounded-full bg-slate-100 flex items-center justify-center mx-auto mb-3">
                    <p.icon className="w-6 h-6 text-slate-600" />
                  </div>
            ...
            <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 rounded-3xl p-12 md:p-16 text-center text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <motion.a href="/getting-started" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="px-8 py-4 bg-white text-blue-600 font-bold rounded-xl hover:bg-gray-50 transition-colors shadow-lg inline-flex items-center justify-center gap-2">
